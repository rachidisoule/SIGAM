...
.. image:: ../_img/referentiels/produit1.png
	:alt: liste
	:align: center
	:height: 416
	:width: 800
...
.. image:: ../_img/referentiels/produit2.png
	:alt: onglet information 1
	:align: center
	:height: 310
	:width: 700
...
.. image:: ../_img/referentiels/produit3.png
	:alt: onglet information 2
	:align: center
	:height: 363
	:width: 700
...
..
	...
	* **Produit à valoriser (Oui/Non)** :Activé, cet bouton indique que le produit fait l'objet d'une facturation. Seule les produits ayant le bouton à **Oui** peuvent apparaître dans le module de tresorerie.
...
.. image:: ../_img/referentiels/produit4.png
	:alt: onglet information 2
	:align: center
	:height: 388
	:width: 700
...
-----------------------------
Cet onglet vous permet de définir les paramètres d’analyse des produits dans le module achats. 
L’écran se divise en deux parties. Une partie vous permettant de définir les informations à ajouter, et une liste en dessous présentant les données déjà existantes. 	* **Type analyse** : sélectionnez le type d'analyse dans la liste.
	...
	* **Bouton <Ajouter>** : cliquez sur ce bouton pour ajouter l'analyse à la liste en dessous.

.. image:: ../_img/referentiels/produit5.png
	:alt: onglet analyse achat
	:align: center
	:height: 398
	:width: 700
...
Le bouton représentant une calculatrice vous affichera l'écran ci-dessous. Il permet de définir la formule de calcul de la valeur de l'analyse.
Les analyses ayant une formule, ne peuvent pas faire l'objet de saisie. Leur valeur est automatique calculée par le programme.

.. image:: ../_img/referentiels/produit6.png
	:alt: onglet analyse achat
	:align: center
	:height: 362
	:width: 400
...
-----------------------------	
Cet onglet vous permet de définir les paramètres d’analyse des produits dans le module usinage.
Le fonctionnement de cet onglet est identique à celui des **analyses pour les achats**.

.. image:: ../_img/referentiels/produit7.png
	:alt: onglet analyse usinage
	:align: center
	:height: 387
	:width: 700
...
**Onglet : Qualités**
-----------------------------	
Cet onglet vous permet de définir les paramètres de détermination de la qualité des produits achetés ou usinés. 
Cet écran se divise en deux parties. La première partie permet d’indiquer pour une qualité, l’analyse associée et les valeurs minimum et maximum autorisées.
La deuxième présente le détail des analyses par qualité que vous avez déjà saisie.

.. image:: ../_img/referentiels/produit8.png
	:alt: onglet qualité
	:align: center
	:height: 364
	:width: 700
...
**Onglet : Réfactions**
-----------------------------	
Cet onglet permet de définir les paramètres de détermination de la réfaction à appliquer sur les achats
Le logiciel offre deux types de réfactions :
...
.. image:: ../_img/referentiels/produit9.png
	:alt: onglet réfaction
	:align: center
	:height: 112
	:width: 652
...
.. image:: ../_img/referentiels/produit10.png
	:alt: onglet réfaction
	:align: center
	:height: 333
	:width: 700
...
**Onglet : Journaux**
-----------------------------		
Cet onglet permet de définir les journaux à utiliser par usines lors de la comptabilisation des écritures
L'écran se divise en deux parties. La partie du haut vous permet de saisir vous informations sur les journaux et de les ajouter dans la liste en dessous via le bouton **<Ajouter>**.
...
.. image:: ../_img/referentiels/produit11.png
	:alt: onglet journaux
	:align: center
	:height: 335
	:width: 700
...
**Onglet : Périodes**
-----------------------------
.. image:: ../_img/referentiels/produit12.png
	:alt: onglet Périodes
	:align: center
	:height: 215
	:width: 700
...
**Onglet : Conteneurs**
-----------------------------
.. image:: ../_img/referentiels/produit13.png
	:alt: onglet Conteneurs
	:align: center
	:height: 176
	:width: 700	
...
-------------------------------
.. image:: ../_img/referentiels/produit14.png
	:alt: onglet Prix de référence
	:align: center
	:height: 148
	:width: 700	
...
**Onglet : Commission**
-----------------------------
.. image:: ../_img/referentiels/produit15.png
	:alt: onglet Commission
	:align: center
	:height: 211
	:width: 700		
