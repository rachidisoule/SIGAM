...
Cette option permet de définir les ponts bascules utilisés pour peser le produit.
La liste des ponts bascules vous propose deux onglets :
...
.. image:: ../_img/referentiels/pontbascule1.png
	:alt: liste
	:align: center
	:height: 354
	:width: 800 
	
Le bouton **Configurer** permet de configurer le logiciel de lecture de poids automatique des ponts bascules.
Ce logiciel est **SIGAM Extension** qui fait l'objet d'une autre documentation que vous trouverez ici.
   
.. image:: ../_img/referentiels/pontbascule2.png
	:alt: liste
	:align: center
	:height: 411
	:width: 800 
...
.. image:: ../_img/referentiels/pontbascule3.png 
	:alt: édition 
	:align: center 
	:height: 256 
	:width: 800 
...
Cette zone permet de définir le type de lecteur auquel SIGAM doit se connecter afin de récupérer automatiquement le poids sur le pont bascule.
	...
	* **Commande** : indiquez ici la commande à exécuter si le bouton <Envoyer commande> est activé.
...
.. image:: ../_img/referentiels/pontbascule4.png
	:alt: édition
	:align: center
	:height: 294
	:width: 800 
...
.. image:: ../_img/referentiels/pontbascule5.png
	:alt: édition
	:align: center
	:height: 295
	:width: 800 
